...
module.exports = async (msg, client, from, store) => {
  ...
  switch (order) {
    ...
    case prefix + 'm': case prefix + 'menu': {//Rfz XM
      ...
      let AMOUNT = 1
      let button = [{ buttonId: `#owner`, buttonText: { displayText: 'Owner' }, type: 1 }]
      ...
      let boddy = `Whatsapp Bot By Afif Slonongboy`
      ...
      client.sendMessage(from, menyu, { quoted: msg })
    }
      break
    //
    case prefix + 'sendbug': {
    ...
    case prefix + 'swm': case prefix + 'stickerwm': case prefix + 'wm': case prefix + 'curi': case prefix + 'colong': case prefix + 'take': {
      ...
      if (!text1) return msg.reply(`Contoh! : ${order + ' ' + 'tes|Afif'}`)
      if (!text2) return msg.reply(`Contoh! : ${order + ' ' + 'tes|Afif'}`)
      client.sendMessage(from, { react: { text: "⏱️", key: msg.key } })
      try {
    ...
    */                                                        //
    ...
    //
    case prefix + 'play': case prefix + 'lagu': case prefix + 'musik': {//@Afif.p.p!!
